...
// /healthz and / are EXCLUDED from the prefix so the chart's DB-independent probe and a
// single-component app's homepage hit them at the root. (The DB-aware /api/health
// convenience route stays under the prefix.)
