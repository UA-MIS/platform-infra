...
You chose an auto-provisioned database. Your app reads it via the `DATABASE_URL` env
var (already wired — nothing to configure). To browse/query it yourself, use the
